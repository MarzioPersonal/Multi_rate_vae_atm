...
def get_dataloaders(train_dataset,
    ...
    if val_size is not None:
        ...
        dataset_train, dataset_val = torch.utils.data.random_split(train_dataset, lengths=[train_size, val_size],
                                                                   generator=generator)
        train_dataloader = DataLoader(dataset_train, shuffle=shuffle, batch_size=batch_size_train, pin_memory=True)
        val_dataloader = DataLoader(dataset_val, shuffle=False, batch_size=batch_size_train, pin_memory=True)
    else:
        train_dataloader = DataLoader(train_dataset, shuffle=shuffle, batch_size=batch_size_train, pin_memory=True)
        val_dataloader = None
